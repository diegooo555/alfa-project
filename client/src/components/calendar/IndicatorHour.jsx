...
const IndicatorHour = ()  => {
  ...
  return (
    <div className="w-full h-[2.5px] bg-red-600 absolute" style={{top: `${currentPosition}%`}}></div>
  )
}

export default IndicatorHour

IndicatorHour.propTypes = {
    scrollableContainerRef: PropTypes.any
}